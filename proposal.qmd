...
We could allow the user to choose from a variety of options for modelling fluid properties. Whether that's the lookup tables we use now, Hafnium's modelling software, or existing Julia packages.
